<div class="marcas index">
	...
	<tr>
		...
		<td><?php echo h($marca['Marca']['logo']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $marca['Marca']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $marca['Marca']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
